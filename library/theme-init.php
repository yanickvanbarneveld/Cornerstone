...
function setup() {
	...
	// After we cleaned up the WordPress Header it is smart to use some handy stuff for our WordPress Header.
	...
	// So the final step is to add the navigation menu and then we can play!
